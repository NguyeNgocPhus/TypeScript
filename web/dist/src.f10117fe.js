...
var Model = function () {
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attributes.getAll()).then(function (data) {
      _this.trigger('save');
    });
  };
...
var Eventing = function () {
  function Eventing() {
    ...
    this.on = function (evenName, callback) {
      var handlers = _this.events[evenName] || [];
      handlers.push(callback);
      _this.events[evenName] = handlers;
    };
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (res) {
      res.data.forEach(function (val) {
        _this.model.push(_this.deserialize(val));
      });
    });
  };
...
},{"./Eventing":"src/model/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/model/User.ts":[function(require,module,exports) {
"use strict";
...
var User = function (_super) {
  ...
  User.buildUser = function (attr) {
    return new User(new Attributes_1.Attributes(attr), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(url));
  };
...
exports.User = User;
},{"./Model":"src/model/Model.ts","./ApiSync":"src/model/ApiSync.ts","./Attributes":"src/model/Attributes.ts","./Eventing":"src/model/Eventing.ts","./Collection":"src/model/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var user = User_1.User.buildCollection();
user.fetch();
console.log(user.model);
},{"./model/User":"src/model/User.ts"}],"C:/Users/ADMIN/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
